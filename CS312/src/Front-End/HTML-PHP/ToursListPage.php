...
<head>
    <meta charset="UTF-8">
    <title>N`adair | Our Top Tours</title>
...
<br>
    <h1 id="IntroHead">Our Top Tours From All Locations!</h1>
    <h2 id="HeadMid">Take a look at some of the tours we believe you would enjoy!</h2>
    <br>
    <h2 id="HeadLower">Top Tours from Glasgow!</h2>
    <!-- We potentially use an image Gallery system to display all of the tours, and once you click
    it takes you do the tour details page, for that entry-->

<!--Linked the database-->
<?php require("DatabaseConnection.php");
$sqlBestGlasgow = "SELECT * FROM `CS312Tours` WHERE `LocationTag` = 'Glasgow' ORDER BY StarRating DESC; ";//note do not have `abc01234`. in front of the table name if you used $dbname to connect
$resultBG = $conn->query($sqlBestGlasgow);

echo '<section class = "container">';    // Opens Container

if ($resultBG->num_rows > 0) {      // Best of Glasgow Result (Based on Star Rating on SQL Result)
...
<ul class="pagination">
    ...
    <li><a class="active" href="https://devweb2025.cis.strath.ac.uk/~mjb23137/CS312%20Assessment/src/Front-End/HTML-PHP/ToursListPage.php">1</a></li>
    ...
    <li><a href="https://devweb2025.cis.strath.ac.uk/~mjb23137/CS312%20Assessment/src/Front-End/HTML-PHP/ToursListPage2.php">&raquo;</a></li>
</ul>
