...
<head>
    <meta charset="UTF-8">
    <title>N`adair | Edinburgh Tours</title>
...
<br>
<h1 id="IntroHead">Edinburgh Tours!</h1>
<h2 id="HeadMid">Take a look at some of the tours we believe you would enjoy!</h2>
<br>
<h2 id="HeadLower">Top Tours from Edinburgh</h2>
<!-- We potentially use an image Gallery system to display all of the tours, and once you click it
it takes you do the tour details page, for that entry (Outdated, replaced with Container now) -->
<?php require("DatabaseConnection.php");
$sqlBestEdinburgh = "SELECT * FROM `CS312Tours` WHERE `LocationTag` = 'Edinburgh' ORDER BY StarRating DESC; ";//note do not have `abc01234`. in front of the table name if you used $dbname to connect
$resultBE = $conn->query($sqlBestEdinburgh);


echo '<section class = "container">';    // Opens Container

if ($resultBE->num_rows > 0) {      // Best of Glasgow Result (Based on Star Rating on SQL Result)
...
<ul class="pagination">
    <li><a href="https://devweb2025.cis.strath.ac.uk/~mjb23137/CS312%20Assessment/src/Front-End/HTML-PHP/ToursListPage.php">&laquo;</a></li>
    <li><a href="https://devweb2025.cis.strath.ac.uk/~mjb23137/CS312%20Assessment/src/Front-End/HTML-PHP/ToursListPage.php">1</a></li>
    <li><a class="active" href="https://devweb2025.cis.strath.ac.uk/~mjb23137/CS312%20Assessment/src/Front-End/HTML-PHP/ToursListPage2.php">2</a></li>
    <li><a href="https://devweb2025.cis.strath.ac.uk/~mjb23137/CS312%20Assessment/src/Front-End/HTML-PHP/ToursListPage3.php">3</a></li>
    <li><a href="https://devweb2025.cis.strath.ac.uk/~mjb23137/CS312%20Assessment/src/Front-End/HTML-PHP/ToursListPage4.php">4</a></li>
    <li><a href="https://devweb2025.cis.strath.ac.uk/~mjb23137/CS312%20Assessment/src/Front-End/HTML-PHP/ToursListPage3.php">&raquo;</a></li>
</ul>
<div class="FooterDiv">
    <br>
