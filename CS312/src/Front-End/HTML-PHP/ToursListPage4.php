...
<head>
    <meta charset="UTF-8">
    <title>N`adair | Glasgow Tours</title>
...
<br>
<h1 id="IntroHead">Inverness and Other Tours!</h1>
...
it takes you do the tour details page, for that entry-->
<?php require("DatabaseConnection.php");
$sqlBestInvernessOther = "SELECT * FROM `CS312Tours` WHERE `LocationTag` = 'Inverness' OR `LocationTag` = 'Other' ORDER BY StarRating DESC; ";//note do not have `abc01234`. in front of the table name if you used $dbname to connect
$resultBI = $conn->query($sqlBestInvernessOther);


echo '<section class = "container">';    // Opens Container

if ($resultBI->num_rows > 0) {      // Best of Glasgow Result (Based on Star Rating on SQL Result)
...
<ul class="pagination">
    <li><a href="https://devweb2025.cis.strath.ac.uk/~mjb23137/CS312%20Assessment/src/Front-End/HTML-PHP/ToursListPage3.php">&laquo;</a></li>
    ...
    <li><a class="active" href="https://devweb2025.cis.strath.ac.uk/~mjb23137/CS312%20Assessment/src/Front-End/HTML-PHP/ToursListPage4.php">4</a></li>
